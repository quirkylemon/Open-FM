...
public:
  ...
  // this is kept up to date with the midi messages that arrive, and the UI
  // component registers with it so it can represent the incoming messages
  ...
  float getDpiScaleFactor() { return dpiScaleFactor; }
